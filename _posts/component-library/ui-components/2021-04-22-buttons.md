...
Do not use buttons as navigational elements. Instead, use [Links](/components/links/) when the desired action is to take the user to a new page.
...
You can include an icon inside a button. Select one from [COINS Icons](/components/icons/).
