...
<div class="icon-grid">
  ...
  {% include icon-block.html icon="icn-Archive" %}
  ...
  {% include icon-block.html icon="icn-Award" %}
  {% include icon-block.html icon="icn-Ball" %}
  ...
  {% include icon-block.html icon="icn-Book" %}
  {% include icon-block.html icon="icn-Briefcase" %}
  {% include icon-block.html icon="icn-Building" %}
  ...
  {% include icon-block.html icon="icn-Certificate" %}
  {% include icon-block.html icon="icn-Chart" %}
  {% include icon-block.html icon="icn-Chart-Alt" %}
  {% include icon-block.html icon="icn-Check" %}
  {% include icon-block.html icon="icn-Check-Double" %}
  ...
  {% include icon-block.html icon="icn-Energy" %}
  ...
  {% include icon-block.html icon="icn-Flag" %}
  ...
  {% include icon-block.html icon="icn-For-Sale" %}
  {% include icon-block.html icon="icn-Fuel" %}
  {% include icon-block.html icon="icn-Grave" %}
  {% include icon-block.html icon="icn-Grid" %}
  {% include icon-block.html icon="icn-Health" %}
  ...
  {% include icon-block.html icon="icn-Important-Triangle" %}
  {% include icon-block.html icon="icn-Info" %}
  {% include icon-block.html icon="icn-Info-Alt" %}
  ...
  {% include icon-block.html icon="icn-Meter" %}
  {% include icon-block.html icon="icn-Mic" %}
  {% include icon-block.html icon="icn-Minimise" %}
  {% include icon-block.html icon="icn-Minus" %}
  {% include icon-block.html icon="icn-Monitor" %}
  ...
  {% include icon-block.html icon="icn-Network" %}
  {% include icon-block.html icon="icn-No-Connection" %}
  {% include icon-block.html icon="icn-No-Connection-Alt" %}
  {% include icon-block.html icon="icn-Notes" %}
  {% include icon-block.html icon="icn-Online-Document" %}
  {% include icon-block.html icon="icn-Online-Spreadsheet" %}
  {% include icon-block.html icon="icn-Open" %}
  {% include icon-block.html icon="icn-PDF" %}
  {% include icon-block.html icon="icn-PDF-Alt" %}
  {% include icon-block.html icon="icn-Package" %}
  {% include icon-block.html icon="icn-Package-Alt" %}
  {% include icon-block.html icon="icn-Package-Confirmed" %}
  {% include icon-block.html icon="icn-Parking" %}
  {% include icon-block.html icon="icn-People" %}
  {% include icon-block.html icon="icn-Percent" %}
  ...
  {% include icon-block.html icon="icn-Pivot" %}
  {% include icon-block.html icon="icn-Play" %}
  {% include icon-block.html icon="icn-Plus" %}
  {% include icon-block.html icon="icn-Plus-Circle" %}
  {% include icon-block.html icon="icn-Print" %}
  {% include icon-block.html icon="icn-Priority" %}
  {% include icon-block.html icon="icn-Process" %}
  {% include icon-block.html icon="icn-QR-code" %}
  {% include icon-block.html icon="icn-Quantity" %}
  {% include icon-block.html icon="icn-Question-Mark" %}
  {% include icon-block.html icon="icn-Refresh" %}
  {% include icon-block.html icon="icn-Reject" %}
  {% include icon-block.html icon="icn-Restore" %}
  ...
  {% include icon-block.html icon="icn-Sidebar" %}
  {% include icon-block.html icon="icn-Site" %}
  {% include icon-block.html icon="icn-Site-Alt" %}
  {% include icon-block.html icon="icn-Sort-Both" %}
  {% include icon-block.html icon="icn-Sorting" %}
  {% include icon-block.html icon="icn-Spinner" %}
  {% include icon-block.html icon="icn-Spreadsheet" %}
  {% include icon-block.html icon="icn-Square" %}
  {% include icon-block.html icon="icn-Star" %}
  {% include icon-block.html icon="icn-Status" %}
  {% include icon-block.html icon="icn-Stop" %}
  ...
  {% include icon-block.html icon="icn-Triangle" %}
  {% include icon-block.html icon="icn-Undo" %}
  {% include icon-block.html icon="icn-Undo-Circle" %}
  {% include icon-block.html icon="icn-Unlinked" %}
  {% include icon-block.html icon="icn-Unlock" %}
  {% include icon-block.html icon="icn-Wallet" %}
  {% include icon-block.html icon="icn-Word" %}
  {% include icon-block.html icon="icn-Work" %}
  {% include icon-block.html icon="icn-Worker" %}
  {% include icon-block.html icon="icn-Wrench" %}
...
{% capture type-filled %}
<div class="icon-grid">
  {% include icon-block.html icon="icn-Add-Package-Filled" %}
  {% include icon-block.html icon="icn-Add-Worker-Filled" %}
  {% include icon-block.html icon="icn-Airplane-Filled" %}
  {% include icon-block.html icon="icn-Approve-Filled" %}
  {% include icon-block.html icon="icn-Archive-Filled" %}
  {% include icon-block.html icon="icn-Arrow-Down-Filled" %}
  {% include icon-block.html icon="icn-Arrow-Left-Filled" %}
  {% include icon-block.html icon="icn-Arrow-Right-Filled" %}
  {% include icon-block.html icon="icn-Arrow-Up-Filled" %}
  {% include icon-block.html icon="icn-Attachment-Filled" %}
  {% include icon-block.html icon="icn-Award-Filled" %}
  {% include icon-block.html icon="icn-Ball-Filled" %}
  {% include icon-block.html icon="icn-Basket-Filled" %}
  {% include icon-block.html icon="icn-Bed-Filled" %}
  {% include icon-block.html icon="icn-Bell-Filled" %}
  {% include icon-block.html icon="icn-Blank-Filled" %}
  {% include icon-block.html icon="icn-Blocks-Filled" %}
  {% include icon-block.html icon="icn-Book-Filled" %}
  ...
  {% include icon-block.html icon="icn-Calendar-Day-Filled" %}
  {% include icon-block.html icon="icn-Calendar-Month-Filled" %}
  {% include icon-block.html icon="icn-Calendar-Week-Filled" %}
  {% include icon-block.html icon="icn-Calendar-Workdays-Filled" %}
  {% include icon-block.html icon="icn-Car-Filled" %}
  {% include icon-block.html icon="icn-Cards-Filled" %}
  {% include icon-block.html icon="icn-Caret-Down-Filled" %}
  {% include icon-block.html icon="icn-Caret-Up-Filled" %}
  {% include icon-block.html icon="icn-Certificate-Filled" %}
  {% include icon-block.html icon="icn-Chart-Filled" %}
  {% include icon-block.html icon="icn-Chart-Alt-Filled" %}
  ...
  {% include icon-block.html icon="icn-Checklist-Cogs-Filled" %}
  {% include icon-block.html icon="icn-Checklist-Fail-Filled" %}
  {% include icon-block.html icon="icn-Checklist-Start-Filled" %}
  {% include icon-block.html icon="icn-Checklist-Time-Filled" %}
  {% include icon-block.html icon="icn-Chevron-Down-Filled" %}
  {% include icon-block.html icon="icn-Chevron-Left-Filled" %}
  {% include icon-block.html icon="icn-Chevron-Right-Filled" %}
  {% include icon-block.html icon="icn-Chevron-Up-Filled" %}
  ...
  {% include icon-block.html icon="icn-Compass-Filled" %}
  {% include icon-block.html icon="icn-Complete-Filled" %}
  ...
  {% include icon-block.html icon="icn-Database-Filled" %}
  {% include icon-block.html icon="icn-Delete-Filled" %}
  {% include icon-block.html icon="icn-Delivery-Filled" %}
  {% include icon-block.html icon="icn-Divide-Filled" %}
  {% include icon-block.html icon="icn-Document-Filled" %}
  {% include icon-block.html icon="icn-Double-Arrows-Down-Filled" %}
  {% include icon-block.html icon="icn-Download-Filled" %}
  {% include icon-block.html icon="icn-Drag-Indicator-Filled" %}
  ...
  {% include icon-block.html icon="icn-Employee-List-Filled" %}
  {% include icon-block.html icon="icn-Energy-Filled" %}
  {% include icon-block.html icon="icn-Equal-Filled" %}
  {% include icon-block.html icon="icn-Excel-Filled" %}
  {% include icon-block.html icon="icn-Expand-Filled" %}
  {% include icon-block.html icon="icn-External-Link-Filled" %}
  {% include icon-block.html icon="icn-Eye-Filled" %}
  {% include icon-block.html icon="icn-Favourite-Filled" %}
  ...
  {% include icon-block.html icon="icn-Food-Filled" %}
  {% include icon-block.html icon="icn-For-Sale-Filled" %}
  {% include icon-block.html icon="icn-Fuel-Filled" %}
  ...
  {% include icon-block.html icon="icn-Important-Triangle-Filled" %}
  {% include icon-block.html icon="icn-Information-Filled" %}
  {% include icon-block.html icon="icn-Info-Filled" %}
  {% include icon-block.html icon="icn-Linked-Filled" %}
  {% include icon-block.html icon="icn-List-Filled" %}
  {% include icon-block.html icon="icn-Lock-Filled" %}
  {% include icon-block.html icon="icn-Log-Out-Filled" %}
  {% include icon-block.html icon="icn-Map-Pin-Filled" %}
  {% include icon-block.html icon="icn-Meal-Filled" %}
  {% include icon-block.html icon="icn-Menu-Burger-Filled" %}
  {% include icon-block.html icon="icn-Meter-Filled" %}
  {% include icon-block.html icon="icn-Mic-Filled" %}
  {% include icon-block.html icon="icn-Minimise-Filled" %}
  {% include icon-block.html icon="icn-Minus-Filled" %}
  {% include icon-block.html icon="icn-Monitor-Filled" %}
  {% include icon-block.html icon="icn-More-Horizontal-Filled" %}
  {% include icon-block.html icon="icn-More-Vertical-Filled" %}
  {% include icon-block.html icon="icn-Multiply-Filled" %}
  {% include icon-block.html icon="icn-Network-Filled" %}
  ...
  {% include icon-block.html icon="icn-Online-Document-Filled" %}
  {% include icon-block.html icon="icn-Online-Spreadsheet-Filled" %}
  {% include icon-block.html icon="icn-Open-Filled" %}
  {% include icon-block.html icon="icn-PDF-Filled" %}
  {% include icon-block.html icon="icn-PDF-Alt-Filled" %}
  {% include icon-block.html icon="icn-Package-Filled" %}
  {% include icon-block.html icon="icn-Package-Alt-Filled" %}
  {% include icon-block.html icon="icn-Package-Confirmed-Filled" %}
  {% include icon-block.html icon="icn-Parking-Filled" %}
  {% include icon-block.html icon="icn-People-Filled" %}
  {% include icon-block.html icon="icn-Percent-Filled" %}
  {% include icon-block.html icon="icn-Phone-Filled" %}
  {% include icon-block.html icon="icn-Phone-Mobile-Filled" %}
  {% include icon-block.html icon="icn-Phone-Old-Filled" %}
  {% include icon-block.html icon="icn-Photo-Camera-Filled" %}
  {% include icon-block.html icon="icn-Photo-Camera-Crossed-Filled" %}
  {% include icon-block.html icon="icn-Photo-Switch-Filled" %}
  {% include icon-block.html icon="icn-Pinned-Filled" %}
  {% include icon-block.html icon="icn-Pivot-Filled" %}
  {% include icon-block.html icon="icn-Play-Filled" %}
  {% include icon-block.html icon="icn-Plus-Filled" %}
  {% include icon-block.html icon="icn-Plus-Circle-Filled" %}
  {% include icon-block.html icon="icn-Print-Filled" %}
  {% include icon-block.html icon="icn-Priority-Filled" %}
  {% include icon-block.html icon="icn-Process-Filled" %}
  ...
  {% include icon-block.html icon="icn-Reject-Filled" %}
  {% include icon-block.html icon="icn-Restore-Filled" %}
  {% include icon-block.html icon="icn-Search-Filled" %}
  {% include icon-block.html icon="icn-Search-Check-Filled" %}
  {% include icon-block.html icon="icn-Search-Important-Filled" %}
  {% include icon-block.html icon="icn-Sell-House-Filled" %}
  {% include icon-block.html icon="icn-Sell-House-Pounds-Filled" %}
  ...
  {% include icon-block.html icon="icn-Share-Filled" %}
  ...
  {% include icon-block.html icon="icn-Sidebar-Filled" %}
  {% include icon-block.html icon="icn-Site-Filled" %}
  {% include icon-block.html icon="icn-Site-Alt-Filled" %}
  {% include icon-block.html icon="icn-Sort-Both-Filled" %}
  {% include icon-block.html icon="icn-Sorting-Filled" %}
  {% include icon-block.html icon="icn-Spinner-Filled" %}
  {% include icon-block.html icon="icn-Spreadsheet-Filled" %}
  {% include icon-block.html icon="icn-Square-Filled" %}
  {% include icon-block.html icon="icn-Star-Filled" %}
  {% include icon-block.html icon="icn-Status-Filled" %}
  {% include icon-block.html icon="icn-Stop-Filled" %}
  {% include icon-block.html icon="icn-Stopwatch-Filled" %}
  {% include icon-block.html icon="icn-Sunrise-Filled" %}
  {% include icon-block.html icon="icn-Sunset-Filled" %}
  {% include icon-block.html icon="icn-Switch-Filled" %}
  ...
  {% include icon-block.html icon="icn-Text-Input-Filled" %}
  {% include icon-block.html icon="icn-Timer-Filled" %}
  {% include icon-block.html icon="icn-Trades-Filled" %}
  ...
  {% include icon-block.html icon="icn-Undo-Filled" %}
  {% include icon-block.html icon="icn-Undo-Circle-Filled" %}
  {% include icon-block.html icon="icn-Unlinked-Filled" %}
  {% include icon-block.html icon="icn-Unlock-Filled" %}
  {% include icon-block.html icon="icn-Wallet-Filled" %}
  {% include icon-block.html icon="icn-Word-Filled" %}
  {% include icon-block.html icon="icn-Work-Filled" %}
  {% include icon-block.html icon="icn-Worker-Filled" %}
  {% include icon-block.html icon="icn-Wrench-Filled" %}
...
|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|--|
| ![Coins File Type - CSV](../../img/file-types/CSV.svg) | ![Coins File Type - Doc (colored)](../../img/file-types/Doc (colored).svg) | ![Coins File Type - Doc](../../img/file-types/Doc.svg) | ![Coins File Type - Dot](../../img/file-types/Dot.svg) | ![Coins File Type - Dwg](../../img/file-types/Dwg.svg) | ![Coins File Type - Dxf](../../img/file-types/Dxf.svg) | ![Coins File Type - Excel (colored)](../../img/file-types/Excel (colored).svg) | ![Coins File Type - Excel](../../img/file-types/Excel.svg) | ![Coins File Type - Gif](../../img/file-types/Gif.svg) | ![Coins File Type - Ifc](../../img/file-types/Ifc.svg) | ![Coins File Type - Jpg](../../img/file-types/Jpg.svg) | ![Coins File Type - Mp4](../../img/file-types/Mp4.svg) | ![Coins File Type - Nwd](../../img/file-types/Nwd.svg) | ![Coins File Type - Pdf (colored)](../../img/file-types/Pdf (colored).svg) | ![Coins File Type - Pdf](../../img/file-types/Pdf.svg) | ![Coins File Type - Png](../../img/file-types/Png.svg) | ![Coins File Type - Rfa](../../img/file-types/Rfa.svg) | ![Coins File Type - Rvt](../../img/file-types/Rvt.svg) | ![Coins File Type - Txt (colored)](../../img/file-types/Txt (colored).svg) | ![Coins File Type - Txt](../../img/file-types/Txt.svg) | ![Coins File Type - Unknown](../../img/file-types/Unknown.svg) | ![Coins File Type - XML](../../img/file-types/XML.svg) |
{: .doc-table}
